...
<html lang="fr">
    <head>
        ...
        {{HTML::style('layout/css/bootstrap.min.css')}}
        {{HTML::style('layout/css/bootstrap-theme.min.css')}}
        {{HTML::script('layout/js/bootstrap.min.js')}}
        {{HTML::script('layout/js/npm.js')}}
    ...
    <div id="work-erreur">
        <div class="container_16">
            ...
            <div class="subheader">
                <div class="subheader_line"></div><h2>Connexion</h2><div class="subheader_line">
                </div>
                {{Form::open(array('action' => 'UsersController@login'))}}
                {{ Form::label('pseudo', 'Votre pseudo',array('class' => 'control_label')) }}<br>
                @if(Session::has('erreurMessageCompte'))
                    <p>{{Session::get('erreurMessageCompte');}}</p>
                @endif
                {{ Form::text('pseudo',null,array('class' => 'form-control')) }}<br>
                {{ Form::label('password', 'Votre Mot de pass',array('class' => 'control_label')) }}<br>
                {{ Form::password('password',null,array('class' => 'form-control'))}}<br>
                @if(Session::has('erreurMessagePassword'))
                    <p>{{Session::get('erreurMessagePassword');}}</p>
                @endif
